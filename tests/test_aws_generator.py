...
class AbstractGeneratorTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.TestGenerator = choice(AWS_GENERATORS)
        self.test_config_kwargs = {
            "generator": self.TestGenerator.__name__,
    ...
    def test_timestamp_none(self):
        ...
        with self.assertRaises(ValueError):
            self.TestGenerator.timestamp(None)

    def test_timestamp_invalid(self):
        """Test that the timestamp method fails with an not a date."""
        with self.assertRaises(ValueError):
            self.TestGenerator.timestamp("invalid")
