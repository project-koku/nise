...
class RDSGenerator(AWSGenerator):
    ...
    INSTANCE_TYPES = (
        ('db.t3.medium', '2', '4 GiB', 'EBS-Only', 'Memory Optimized',
         '0.072', '0.072', '${} per On Demand Linux {} Instance Hour'),
        ('db.t3.large', '2', '8 GiB', 'EBS Only', 'General Purpose',
         '0.145', '0.145', '${} per On Demand Linux {} Instance Hour'),
        ('db.m5.xlarge', '4', '16 GiB', '1 x 200 NVMe SSD', 'Compute Optimized',
         '0.356', '0.356', '${} per On Demand Linux {} Instance Hour'),
        ('db.r5.2xlarge', '8', '64 GiB', 'EBS-Only', 'Compute Optimized',
         '1.00', '1.00', '${} per On Demand Linux {} Instance Hour'),
    )
    ...
    def _update_data(self, row, start, end, **kwargs):
        ...
        row['lineItem/UsageType'] = '{}-InstanceUsage:{}'.format(region_short_code, inst_type)
