...
main() {
    ...
    $CONTAINER_RUNTIME run -it \
                           ...
                           -v $KOKU_PATH/testing/local_providers/gcp_local:/tmp/gcp_local_bucket${FLAGS} \
                           -v $KOKU_PATH/testing/local_providers/gcp_local_0:/tmp/gcp_local_bucket_0${FLAGS} \
                           -v $KOKU_PATH/testing/local_providers/gcp_local_1:/tmp/gcp_local_bucket_1${FLAGS} \
                           -v $KOKU_PATH/testing/local_providers/gcp_local_2:/tmp/gcp_local_bucket_2${FLAGS} \
                           -v $KOKU_PATH/testing/local_providers/gcp_local_3:/tmp/gcp_local_bucket_3${FLAGS} \
